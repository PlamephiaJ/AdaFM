...
class OptimizerRegistry:
    ...
    def create_optimizers(
        ...
        return self._optimizers[name](
            generator, discriminator, cfg, results_folder, tb_writer
        )
